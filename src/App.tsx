...
function App() {
  ...
  return (
    <main className='flex flex-col items-center justify-center w-screen h-screen'>
      <BackgroundImage />
      <h1 className='2xl:text-7xl xl:text-6xl xl:mb-8 lg:text-5xl lg:mb-7 md:text-4xl md:mb-6 sm:text-3xl sm:mb-5 text-2xl mb-4 drop-shadow-3xl text-white'>Dragonaere Network</h1>
